...
namespace Zero
{
    ...
    public:
        ...
        ResourceRegistry<RHI::BufferHandle, BufferHandle, 65536> bufferRegistry;
        ResourceRegistry<RHI::TextureHandle, TextureHandle, 16384> textureRegistry;
        ResourceRegistry<RHI::PipelineHandle, PipelineHandle, 4096> pipelineRegistry;
